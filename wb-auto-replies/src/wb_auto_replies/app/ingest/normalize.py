...
def normalize_feedback(source_api: str, payload: dict[str, Any]) -> NormalizedFeedback:
    ...
    text = _pick_first(payload, ["text", "productValuation", "prosText"])
    ...
    videos = _as_list(_pick_first(payload, ["videos", "videoLinks"]))
    ...
    for item in videos:
        if isinstance(item, dict):
            url = _pick_first(item, ["url", "videoUrl", "link"])
        else:
            url = item
        if url:
    ...
    return NormalizedFeedback(
        ...
        nm_id=_pick_first(payload, ["nmId", "nmID"]),
        imt_id=_pick_first(payload, ["imtId", "imtID"]),
        product_name=str(_pick_first(payload, ["productName", "imtName", "name"])) if _pick_first(payload, ["productName", "imtName", "name"]) is not None else None,
        supplier_article=str(_pick_first(payload, ["supplierArticle", "vendorCode"])) if _pick_first(payload, ["supplierArticle", "vendorCode"]) is not None else None,
        brand_name=str(_pick_first(payload, ["brandName", "brand"])) if _pick_first(payload, ["brandName", "brand"]) is not None else None,
        subject_id=_pick_first(payload, ["subjectId", "subjectID"]),
        subject_name=str(_pick_first(payload, ["subjectName", "subject"])) if _pick_first(payload, ["subjectName", "subject"]) is not None else None,
