...
def upgrade() -> None:
    ...
    op.create_index("ix_feedbacks_raw_shop_source_fetched", "feedbacks_raw", ["shop_id", "source_api", "fetched_at"])
    ...
    op.create_index("ix_feedbacks_shop_nm_created", "feedbacks", ["shop_id", "nm_id", "created_date"])
    op.create_index("ix_feedbacks_shop_kind_processing", "feedbacks", ["shop_id", "feedback_kind", "processing_status"])
    op.create_index("ix_feedbacks_shop_latest", "feedbacks", ["shop_id", "is_latest"])
    ...
    op.create_index("ix_reply_drafts_shop_feedback_created", "reply_drafts", ["shop_id", "feedback_id", "created_at"])
    ...
    op.create_index("ix_reply_publications_shop_feedback_published", "reply_publications", ["shop_id", "feedback_id", "published_at"])
    ...
    op.create_index("ix_health_events_component_created", "health_events", ["component", "created_at"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_health_events_component_created", table_name="health_events")
    op.drop_table("health_events")
    op.drop_table("sync_state")
    op.drop_index("ix_reply_publications_shop_feedback_published", table_name="reply_publications")
    op.drop_table("reply_publications")
    op.drop_index("ix_reply_drafts_shop_feedback_created", table_name="reply_drafts")
    op.drop_table("reply_drafts")
    op.drop_table("karmic_reply_rules")
    op.drop_table("semantic_reply_templates")
    op.drop_table("feedback_media")
    op.drop_index("ix_feedbacks_shop_latest", table_name="feedbacks")
    op.drop_index("ix_feedbacks_shop_kind_processing", table_name="feedbacks")
    op.drop_index("ix_feedbacks_shop_nm_created", table_name="feedbacks")
    op.drop_table("feedbacks")
    op.drop_index("ix_feedbacks_raw_shop_source_fetched", table_name="feedbacks_raw")
    op.drop_table("feedbacks_raw")
    op.drop_table("shops")
